...
impl L10n {
    ...
    fn detect_language(&self) -> String {
        ...
        // デフォルト言語
        self.env_provider.var("L10N_DEFAULT_LANGUAGE")
...
// グローバルインスタンス
static GLOBAL_L10N: Lazy<L10n> = Lazy::new(|| {
    L10n::new(Box::new(SystemEnvProvider))
});
...
mod tests {
    ...
    fn test_format_translation() {
        ...
        l10n.force_language("ja");
        assert_eq!(l10n.format("Hello, {}!", &["Alice"]), "こんにちは、Aliceさん！");
    }
